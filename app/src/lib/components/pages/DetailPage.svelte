<script>
    ...
    let detailContent = $state(item.detail);
...
<div class="detail-wrapp pb-20">
    ...
    <div class="bg-white rounded-lg detail-page">
...
<style>
    .detail-page {
        padding: var(--safe-top) 10px var(--safe-bottom + 57px) 10px;
    }
    .swiper {
        width: 100%;
        height: 100%;
